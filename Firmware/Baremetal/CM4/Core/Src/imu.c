...
//  HAL_I2C_Master_Transmit_DMA(settings.device.hi2c1, address<<1, buffer, 2);
//}
//
...
//  HAL_I2C_Master_Receive_DMA(settings.device.hi2c1, address<<1, &readBuffer, 1);
//  return readBuffer;
//}
//
...
//
//  HAL_I2C_Master_Transmit_DMA(settings.device.hi2c1, address<<1, &buffer, 1);
//  HAL_I2C_Master_Receive_DMA(settings.device.hi2c1, address<<1, dest, count);
//  return count;
//}
